...
class CampaignTrackingServiceUnitTest extends PHPUnit\Framework\TestCase
{
    ...
    public static function setUpBeforeClass() : void
    {
        ...
        $bounces = JsonLoader::getBounces();
        $clicks = JsonLoader::getClicks();
        $forwards = JsonLoader::getForwards();
        $unsubscribes = JsonLoader::getOptOuts();
        $sends = JsonLoader::getSends();
        $opens = JsonLoader::getOpens();
        $summary = JsonLoader::getSummary();

        $mock = new MockHandler([
            new Response(200, array(), $bounces),
            new Response(200, array(), $clicks),
            new Response(200, array(), $forwards),
            new Response(200, array(), $unsubscribes),
            new Response(200, array(), $sends),
            new Response(200, array(), $opens),
            new Response(200, array(), $summary)
        ]);
